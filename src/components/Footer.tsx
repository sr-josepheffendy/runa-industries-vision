...
const Footer = () => {
  return (
    <footer className="bg-runaEarth text-white pt-16 pb-8">
      <div className="container mx-auto container-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Runa</h3>
            <p className="mb-4 text-gray-300">
              Shaping the future of Indonesia's industrial economy through mining, engineering, and heavy equipment solutions.
            </p>
